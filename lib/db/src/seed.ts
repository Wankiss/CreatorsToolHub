...
const tools = [
  ...
  { name: "AI Prompt Generator", slug: "ai-prompt-generator", categorySlug: "ai-creator-tools", description: "Generate structured, role-based AI prompts for ChatGPT, Claude, and Gemini that produce professional-quality content on the first attempt. Covers YouTube scripts, Instagram captions, TikTok content, email newsletters, blog posts, and more — no prompt engineering experience required.", shortDescription: "Create expert AI prompts for ChatGPT, Claude, and Gemini instantly.", icon: "⚡" },
  { name: "Midjourney Prompt Generator", slug: "midjourney-prompt-generator", categorySlug: "ai-creator-tools", description: "Generate optimized Midjourney prompts with the correct syntax, style descriptors, lighting terms, aspect ratios, and quality parameters for professional AI image generation. Create stunning visuals for YouTube thumbnails, Instagram posts, course covers, and brand identity — no design experience required.", shortDescription: "Generate optimized Midjourney prompts for stunning AI visuals.", icon: "🎨" },
];
