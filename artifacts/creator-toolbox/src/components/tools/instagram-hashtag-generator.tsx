    ...
    <>
      ...
      <section className="mt-2">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold font-display text-foreground">About This Instagram Hashtag Generator</h2>
        </div>
        <div className="space-y-8">
          <div>
            <h3 className="text-lg font-bold text-foreground mb-3 flex items-center gap-2">
              <Zap className="w-4 h-4 text-primary" /> What This Instagram Hashtag Generator Does
            </h3>
            <p className="text-muted-foreground leading-relaxed mb-3">
              Instagram's head Adam Mosseri publicly recommends using 3–5 relevant hashtags for Reels
              rather than filling all 30 slots, because the Reels algorithm classifies content primarily
              through visual and audio signals, not hashtag volume. This tool generates 90 hashtags
              across 3 rotating sets, tiered into Broad (5), Mid-Range (10), and Micro (15) categories
              so you hit every discovery layer simultaneously.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-3">
              You enter your post topic, content niche, content type (Reel, Carousel, or Static), and
              goal (Reach, Engagement, Growth, or Sales). The generator produces hashtags calibrated to
              your inputs, Reel mode weights toward Broad and Mid-Range tags, Carousel mode weights
              toward Micro tags for longer-term ranking. Each set is non-overlapping so you can rotate
              A, B, C across posts without triggering Instagram's repetition-detection system.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-3">
              Pair your hashtags with a well-crafted{" "}
              <Link href="/tools/instagram-caption-generator" className="text-primary hover:underline font-medium">
                Instagram caption
              </Link>{" "}
              and plan which posts get which sets using the{" "}
              <Link href="/tools/instagram-reel-idea-generator" className="text-primary hover:underline font-medium">
                Reel Idea Generator
              </Link>{" "}
             , content quality and hashtag targeting compound each other.
            </p>
          </div>

          <div>
            <h3 className="text-lg font-bold text-foreground mb-3 flex items-center gap-2">
              <TrendingUp className="w-4 h-4 text-primary" /> Why Hashtag Strategy Changed and What Works Now
            </h3>
            <p className="text-muted-foreground leading-relaxed mb-3">
              The old 30-hashtag spray-and-pray approach is dead. Meta's{" "}
              <a href="https://transparency.fb.com/features/ranking/instagram/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                Transparency Center
              </a>{" "}
              confirms hashtags are one of several classification signals, alongside caption text, audio
              cues, and visual content, that determine how Instagram distributes your posts. On a
              platform with over{" "}
              ...
              , algorithm classification determines whether your content reaches 200 people or 20,000.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-3">
              Niche hashtags with under 500K posts consistently outperform oversaturated broad tags for
              actual follower growth. A post in the #fitness feed (500M+ posts) disappears in seconds.
              A post in #kettlebellmomworkout (under 50K posts) can sit on the first page for days. That
              difference in visibility window is what makes the Micro tier so valuable, it's not about
              reach volume, it's about staying visible long enough for your ideal audience to find you.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-3">
              Rotating hashtag sets also protects you from Instagram's spam detection. Meta's Help
              Center documents that repetitive posting behavior can reduce distribution. Copy-pasting
              the same 30 tags on every post is a red flag. Three non-overlapping sets keep your
              pattern varied while maintaining consistent niche relevance, that's exactly what this
              tool generates.
            </p>
          </div>
          ...
          <figure style={{margin:"1rem 0 2rem",position:"relative",paddingBottom:"56.25%",height:0,overflow:"hidden",borderRadius:"12px"}}>
            <iframe style={{position:"absolute",top:0,left:0,width:"100%",height:"100%",border:0}}
              srcdoc="<style>*{padding:0;margin:0;overflow:hidden}html,body{height:100%}img,span{position:absolute;width:100%;top:0;bottom:0;margin:auto}span{height:1.5em;text-align:center;font:48px/1.5 sans-serif;color:white;text-shadow:0 0 0.5em black}</style><a href='https://www.youtube.com/embed/Skhq8dU9MfY?autoplay=1'><img src='https://img.youtube.com/vi/Skhq8dU9MfY/maxresdefault.jpg' alt='Instagram Hashtag Strategy 2025, What Actually Works'><span>&#9654;</span></a>"
              loading="lazy"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowFullScreen
              title="Instagram Hashtag Strategy 2025, What Actually Works"
              aria-label="Video explaining the Instagram hashtag strategy that drives real reach and follower growth in 2025"
            ></iframe>
            <noscript><a href="https://www.youtube.com/watch?v=Skhq8dU9MfY" target="_blank" rel="noopener">Watch: Instagram Hashtag Strategy 2025, What Actually Works on YouTube</a></noscript>
          </figure>

          <div>
            <h3 className="text-lg font-bold text-foreground mb-4 flex items-center gap-2">
              <BarChart2 className="w-4 h-4 text-primary" /> Benefits of Using This Instagram Hashtag Generator
            </h3>
            <div className="grid sm:grid-cols-2 gap-3">
              {[
                "Generates 90 hashtags across 3 rotating sets, use a different set each post to avoid repetition penalties",
                "Tiered 5 Broad + 10 Mid-Range + 15 Micro distribution captures every discovery layer simultaneously",
                "Reel mode weights toward Broad and Mid tags; Carousel mode weights toward Micro for feed ranking",
                "4 goal modes (Reach, Engagement, Growth, Sales) fine-tune which supplementary tags appear in each tier",
                "15 supported niches, hashtag pools and keyword expansions are calibrated per category",
                "Topic-specific generation converts your post topic into camelCase, PascalCase, and long-tail hashtag variants",
                "Keywords field lets you inject your own niche terms directly into the Micro tier for precise targeting",
                "Copy individual tiers or all 30 at once, test subsets of 5, 10, or 15 to find your account's sweet spot",
                "Rotation guide shows all 3 sets side by side, plan your full posting week before filming anything",
                "Free, unlimited, no signup, generate fresh sets whenever you start a new content series",
              ].map((text, i) => (
      ...
      <div className="bg-primary/5 border border-primary/20 rounded-2xl p-4 mt-4">
        <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          Instagram's head Adam Mosseri publicly recommends 3–5 relevant hashtags for Reels rather than
          filling all 30 slots (
          <a href="https://www.instagram.com/mosseri/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">@mosseri on Instagram</a>
          ), as Reels distribution is driven by content signals, not hashtag volume. Meta's{" "}
          <a href="https://transparency.fb.com/features/ranking/instagram/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Transparency Center</a>{" "}
          confirms hashtags as one of Instagram's content classification signals. Niche hashtags under
          500K posts consistently outperform oversaturated broad tags for sustained feed visibility and
          follower growth among engaged audiences.
        </p>
      </div>
