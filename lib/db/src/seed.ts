...
const tools = [
  ...
  { name: "YouTube Channel Growth Calculator", slug: "youtube-channel-growth-calculator", categorySlug: "youtube-tools", description: "Project your YouTube channel subscriber growth and estimate when you will reach monetization thresholds and major milestones. Plan your content strategy with data-driven growth projections.", shortDescription: "Project your YouTube channel growth and estimate when you will hit subscriber milestones.", icon: "🚀" },
