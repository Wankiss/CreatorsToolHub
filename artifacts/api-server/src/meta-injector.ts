...
export async function resolvePageMeta(rawPathname: string): Promise<PageMeta | null> {
  ...
  const TOOL_OG_IMAGES: Record<string, string> = {
    "youtube-title-generator":           `${SITE_URL}/api/uploads/46bf1148-37f0-482d-b9a7-7e084f210989.png`,
    "youtube-tag-generator":             `${SITE_URL}/api/uploads/d0e348c0-62b0-4b6a-a5c9-249f826ec932.png`,
    "youtube-tag-extractor":             `${SITE_URL}/api/uploads/048ea8b9-4aad-42c0-9099-f070ce6fe220.png`,
    "youtube-description-generator":     `${SITE_URL}/api/uploads/2ceddb16-cd7c-43a7-b54e-5cd72893d692.png`,
    "youtube-channel-name-generator":    `${SITE_URL}/api/uploads/537212bf-5c79-4415-90b0-3a26c09237fa.png`,
    "youtube-money-calculator":          `${SITE_URL}/api/uploads/5546d2f5-ba8b-4697-9ca3-e63046b288dc.png`,
    "youtube-thumbnail-downloader":      `${SITE_URL}/api/uploads/bcf12dba-e9ac-44f1-904f-27610fde29c2.png`,
    "youtube-hashtag-generator":         `${SITE_URL}/api/uploads/409e50e5-576c-4a37-b816-ec9382e07571.png`,
    "youtube-shorts-revenue-calculator": `${SITE_URL}/api/uploads/3e2a9729-b9a8-4205-9bfc-3d055ac998a1.png`,
    "youtube-video-idea-generator":      `${SITE_URL}/api/uploads/d40b6f18-c509-404e-89e5-f0c6a45ed0fd.png`,
    "youtube-seo-score-checker":         `${SITE_URL}/api/uploads/a4a06cb9-151c-436d-9250-e149434bf9fc.png`,
    "youtube-cpm-calculator":            `${SITE_URL}/api/uploads/7dc24084-b5fa-46ec-87f7-d277a424ee9e.png`,
    "youtube-title-analyzer":            `${SITE_URL}/api/uploads/9dcb4de3-adee-4150-99f8-85e4a6b00aa9.png`,
    "youtube-keyword-generator":         `${SITE_URL}/api/uploads/746ea470-12ea-4766-b925-74c423807cf5.png`,
    "youtube-script-generator":          `${SITE_URL}/api/uploads/ebdbc01a-6924-4db7-8a0f-7c588a72bf64.png`,
    "youtube-engagement-calculator":     `${SITE_URL}/api/uploads/cb619022-86e7-476c-a2dd-5dc86c1354a2.png`,
    "tiktok-viral-idea-generator":       `${SITE_URL}/api/uploads/711f957b-3fc4-43b6-92fc-e8d3c63e349a.png`,
    "tiktok-hook-generator":             `${SITE_URL}/api/uploads/ba235909-5792-40b7-bb82-6caa78c05573.png`,
    "tiktok-script-generator":           `${SITE_URL}/api/uploads/f5d1188c-adee-4fa1-b65f-da3c6bc3581d.png`,
    "tiktok-caption-generator":          `${SITE_URL}/api/uploads/0cd69ef9-c485-481b-bdf4-05e2fc0d63bc.png`,
    "tiktok-hashtag-generator":          `${SITE_URL}/api/uploads/f0383dc7-ca4e-4435-9a17-8c73b3b3d13f.png`,
    "tiktok-money-calculator":           `${SITE_URL}/api/uploads/3861bf73-b586-4006-a513-e3c05955d33e.png`,
    "tiktok-bio-generator":              `${SITE_URL}/api/uploads/75385f72-d0f1-4cf9-ba78-7af2ece12f31.png`,
    "tiktok-username-generator":         `${SITE_URL}/api/uploads/5280e888-b414-4432-852b-82140c9a4d9d.png`,
    "instagram-hashtag-generator":       `${SITE_URL}/api/uploads/fcaf4668-d5b8-40ba-b5b8-b77c378eb5cb.png`,
    "instagram-caption-generator":       `${SITE_URL}/api/uploads/9c037f03-3bc4-4aac-8071-9f4f16857683.png`,
    "instagram-bio-generator":           `${SITE_URL}/api/uploads/0c4582fe-822c-4e99-bb43-60ed7ee78582.png`,
    "instagram-username-generator":      `${SITE_URL}/api/uploads/426a8d8e-a85c-4e81-891e-7eed21cadba9.png`,
    "instagram-reel-idea-generator":     `${SITE_URL}/api/uploads/5a49b707-95a7-45f2-b914-4acf040926b2.png`,
    "instagram-hook-generator":          `${SITE_URL}/api/uploads/8b83ff79-9453-4887-a7bb-b752b79107b1.png`,
    "instagram-engagement-calculator":   `${SITE_URL}/api/uploads/77188a58-3e5f-4a75-ab72-142e1e3873f9.png`,
    "instagram-money-calculator":        `${SITE_URL}/api/uploads/26362956-3108-4712-8aeb-878021ea3cb0.png`,
    "instagram-content-planner":         `${SITE_URL}/api/uploads/d45125bb-f050-4f56-a6de-e924aa0e4da7.png`,
    "ai-prompt-generator":               `${SITE_URL}/api/uploads/46cd0f33-74e9-4454-bcd8-b81e23a333e9.png`,
    "midjourney-prompt-generator":       `${SITE_URL}/api/uploads/887aa7e8-be20-4ce4-b4f9-22e518c440a8.png`,
  };

  const CATEGORY_OG_IMAGES: Record<string, string> = {
    "youtube-tools":   `${SITE_URL}/api/uploads/8147aaec-ae89-4c82-9216-9dea3fedac10.png`,
    "tiktok-tools":    `${SITE_URL}/api/uploads/f3c2a4c1-2779-4267-8575-83784e94e209.png`,
    "instagram-tools": `${SITE_URL}/api/uploads/5be51698-b619-475f-924b-bf8ba506e84e.png`,
    "ai-creator-tools":`${SITE_URL}/api/uploads/48a194bc-1883-4914-9fb2-8addeec1b1dc.png`,
  };
