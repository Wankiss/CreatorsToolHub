...
import {
  ...
  Lightbulb, Users, Clock, BarChart2, Flame, Film, ArrowUpRight,
} from "lucide-react";
...
const IDEA_BANK: Record<Niche, IdeaTemplate[]> = {
  fitness: [
    ...
    { title: `5 fitness myths people still believe in ${YEAR}`, angle: "Education-entertainment hybrid", hook: "Stop believing this fitness advice — it's making you worse", format: "List / Tips", audience: "General fitness audience", goal: "Reach", pillar: "education", filmingTip: "Quick cuts between each myth, counter each with text overlay" },
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: `For most creators, 3–5 Reels per week is the optimal frequency in ${YEAR}. Quality consistently outperforms quantity — a creator posting 3 high-quality, well-hooked Reels per week will grow faster than one posting 7 mediocre Reels. Instagram's algorithm for Reels rewards watch time, replays, shares, and profile visits — metrics that only high-quality content drives. The practical consideration is sustainability: posting 5 Reels per week with strong hooks, relevant topics, and decent production requires roughly 3–5 hours of filming and editing time per week. For beginners, starting with 2–3 per week and building consistency is more effective than committing to daily posting and burning out after two weeks. Advanced creators can post daily (7×/week) if they have a batching system — filming 7 Reels in one 2-hour session rather than creating one per day.`,
  },
  {
